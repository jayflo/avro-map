...
var COMPLEX_TYPES_NAMES = require('./constants').COMPLEX_TYPES_NAMES;

var REGISTERABLE_TYPES = Object.freeze(setKeys({}, [
  COMPLEX_TYPES_NAMES.RECORD,
  COMPLEX_TYPES_NAMES.ENUM,
  COMPLEX_TYPES_NAMES.FIXED
], true));
...
Object.defineProperties(NameRegistry.prototype, {
  ...
  isRegisterable: {value: isRegisterable}
});
...
function representative(enclosingNamespace, entryOrName) {
  var nd = NameDescriptor.create(enclosingNamespace, entryOrName);

  return this._representatives[(nd || {}).representative];
}
